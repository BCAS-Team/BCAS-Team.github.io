...
Promise.all([
  fetch('/BCAS-Wiki 2.0/Hackers Wiki/JSON/tools.json').then(res => res.json()),
  fetch('/BCAS-Wiki 2.0/Hackers Wiki/JSON/tutorials.json').then(res => res.json()),
  fetch('/BCAS-Wiki 2.0/Hackers Wiki/JSON/resources.json').then(res => res.json()),
  fetch('/BCAS-Wiki 2.0/Hackers Wiki/JSON/concepts.json').then(res => res.json())
])
