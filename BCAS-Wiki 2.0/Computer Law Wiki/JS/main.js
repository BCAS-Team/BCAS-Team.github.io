...
Promise.all([
  fetch('/BCAS-Wiki 2.0/Computer Law Wiki/JSON/statutes.json').then(res => res.json()),
  fetch('/BCAS-Wiki 2.0/Computer Law Wiki/JSON/caselaw.json').then(res => res.json()),
  fetch('/BCAS-Wiki 2.0/Computer Law Wiki/JSON/legalconcepts.json').then(res => res.json()),
  fetch('/BCAS-Wiki 2.0/Computer Law Wiki/JSON/legalresources.json').then(res => res.json())
])
