...
Promise.all([
  fetch('/JSON/statutes.json').then(res => res.json()),
  fetch('/JSON/caselaw.json').then(res => res.json()),
  fetch('/JSON/legalconcepts.json').then(res => res.json()),
  fetch('/JSON/legalresources.json').then(res => res.json())
])
